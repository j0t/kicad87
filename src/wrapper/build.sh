...
# output
DEF1=${SRC_NAME}_1.def
DEF2=${SRC_NAME}_2.def
ENTRIES_H=entries.h
...
${GCC} ${LINK_OPTS} -o fwd_util.dll -shared fwd_util.o wraps.o ${DEF2} -Wl,--subsystem,windows -lntdll -L. -l${SRC_NAME}

${CV2PDB64} fwd_util.dll
